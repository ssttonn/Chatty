...
class ChatBubbleView: UIView {
    ...
    override func layoutSubviews() {
        ...
        bubbleLayer.fillColor = incoming ? UIColor(white: 0.90, alpha: 1.0).cgColor : UIColor.primaryColor.cgColor
        chatLabel.textColor = incoming ? UIColor.primaryColor : UIColor.white
